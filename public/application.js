...
/***/ function(module, exports, __webpack_require__) {
	...
	var authLogic = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesSuccess = __webpack_require__(10);
	...
	var clickId = undefined.dataset.id;
	var addClickEvents = undefined.dataset.id;
	// create data object with id as index property value
	var data = {
	  cell: {
	    index: clickId,
	    value: turn
	...
	// pass data object as argument to updateGame
	api.updateGame(data);
	...
	if (turn === 'X') {
	  ...
	  $(undefined).html('O');
	  $(undefined).off();
	  gameBoard[$(undefined).data('id')] = 'O';
	  if (gameBoard[0] === 'O' && gameBoard[1] === 'O' && gameBoard[2] === 'O' || gameBoard[3] === 'O' && gameBoard[4] === 'O' && gameBoard[5] === 'O' || gameBoard[6] === 'O' && gameBoard[7] === 'O' && gameBoard[8] === 'O' || gameBoard[0] === 'O' && gameBoard[3] === 'O' && gameBoard[6] === 'O' || gameBoard[1] === 'O' && gameBoard[4] === 'O' && gameBoard[7] === 'O' || gameBoard[2] === 'O' && gameBoard[5] === 'O' && gameBoard[8] === 'O' || gameBoard[0] === 'O' && gameBoard[4] === 'O' && gameBoard[8] === 'O' || gameBoard[2] === 'O' && gameBoard[4] === 'O' && gameBoard[6] === 'O') {
	    // game won
	...
	var startGame = function startGame() {
	  ...
	  api.createGame().then(function (gameData) {
	...
	var gamesCompletedButton = function gamesCompletedButton() {
	  console.log('im in games completed');
	  $('#games-completed').on('click', ui.getGamesSuccess);
	};
	...
	module.exports = {
	  ...
	  gamesCompletedButton: gamesCompletedButton,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesSuccess = function getGamesSuccess(data) {
	  ...
	  var idGetter = function idGetter() {
